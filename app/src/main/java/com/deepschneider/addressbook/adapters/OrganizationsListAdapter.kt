...
class OrganizationsListAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        rowView.findViewById<TextView>(R.id.organization_item_name).text = organizations[position].name
        rowView.findViewById<TextView>(R.id.organization_item_address_and_zip).text = organizations[position].street + " " + organizations[position].zip
        rowView.findViewById<TextView>(R.id.organization_item_last_updated).text = organizations[position].lastUpdated
        rowView.findViewById<TextView>(R.id.organization_item_id).text = organizations[position].id
        rowView.findViewById<TextView>(R.id.organization_item_type).text = organizations[position].type
        return rowView
    }
}